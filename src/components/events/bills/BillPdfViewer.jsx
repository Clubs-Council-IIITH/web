...
import {
  Dialog, DialogTitle, DialogContent, IconButton, Button, Box, Typography,
} from "@mui/material";
  ...
  >
    ...
    >
      ...
      {isMobile ? (// Mobile layout
        <Box
          sx={{
            display: "flex", flexDirection: "column", gap: 1.5, mt: 2, mb: 2, width: "100%",
          }}
        >
          {/* Download Button */}
          <Button
    ...
    >
      {isMobile ? (<Typography variant="body1" mb={5} sx={{textAlign: "center"}}>
