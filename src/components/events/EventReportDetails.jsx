...
import { Box, Button, Grid, Typography, Chip, Divider, CardActionArea } from "@mui/material";
...
export function EventReportDetails({ event, eventReport, submittedUser, clubs }) {
    ...
    return (
        <>
            <Grid container sx={{ justifyContent: "space-between", alignItems: "center", mb: 3 }}>
                <Typography variant="h3" mt={1} mb={2}>
                    Event Report
                </Typography>
                <DownloadEventReport event={event} eventReport={eventReport} submittedUser={submittedUser} clubs={clubs} />
            </Grid>
