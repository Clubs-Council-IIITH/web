                            ...
                            <Grid container spacing={2}>
                                <Grid item xs={12} md={6} xl={6}>
                                    <DateTimePicker
                                        ...
                                        sx={{ width: "100%" }}
                                        value={
                                            defaultValues?.datetimeperiod[0] instanceof Date && !isDayjs(defaultValues?.datetimeperiod[0]) ? dayjs(defaultValues?.datetimeperiod[0]) : defaultValues?.datetimeperiod[0]
                                        }
                                        disabled
                                ...
                                <Grid item xs={12} md={6} xl={6}>
                                    <DateTimePicker
                                        ...
                                        sx={{ width: "100%" }}
                                        value={
                                            defaultValues?.datetimeperiod[1] instanceof Date && !isDayjs(defaultValues?.datetimeperiod[1]) ? dayjs(defaultValues?.datetimeperiod[1]) : defaultValues?.datetimeperiod[1]
                                        }
                                        disabled
                                        format="DD/MM/YYYY hh:mm A"
                                    />
                        ...
                        <Grid item xs={12} mt={2}>
                            <Controller
                                ...
                                rules={{
                                    ...
                                    maxLength: {
                                        value: 5000,
                                        message: "Event description must be at most 5000 characters long!",
                                    },
                                }}
                                        ...
                                        <Select
                                            ...
                                            renderValue={(selected) => (
                                                <Box
                                                    ...
                                                    {selected.map((value) => (
                                                        <Chip key={value} label={value?.replace(/_/g, " ").toUpperCase()} />
                                                    ))}
                                                </Box>
                                            )}
                                            {...field}
