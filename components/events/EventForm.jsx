      ...
      <Grid container spacing={3}>
        <Grid item xs={12} md={6} lg={7} xl={8}>
          <Card sx={{ p: 2 }}>
            ...
            <Stack spacing={2}>
              ...
              <Box>
                ...
                <ToggleButtonGroup color="primary" value={audience} onChange={handleAudienceChange}>
          ...
          <Card sx={{ p: 2, mt: 3 }}>
            ...
            <Button size="small" variant="outlined" onClick={addBudgetItem} sx={{ mb: 1 }}>
                      ...
                      availableRoomsLoading ? (
                        ...
                        <FormControl>
                          ...
                          {!(startDateInput && endDateInput) ? (
                            <FormHelperText>
                              Enter start and end dates to get available rooms
                            </FormHelperText>
                          ) : null}
                        </FormControl>
                      )
