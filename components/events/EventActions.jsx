...
import { Alert, AlertTitle, Button, Checkbox, Grid, Stack, Box, FormGroup, FormControlLabel } from "@mui/material";
import {
    ...
    return (
        <Grid container spacing={2} p={2}>
            {actions.includes("edit") ? (
                <Grid item xs>
                    <Button fullWidth size="large" variant="contained" color="warning" onClick={handleEdit}>
            ...
            {actions.includes("delete") ? (
                <Grid item xs>
                    <Button fullWidth size="large" variant="contained" color="error" onClick={handleDelete}>
            ...
            {actions.includes("submit") ? (
                <Grid item xs>
                    <Button fullWidth size="large" variant="contained" color="info" onClick={handleSubmit}>
            ...
            {actions.includes("approve") ? (
                <Grid item xs>
                    <Button fullWidth size="large" variant="contained" color="success" onClick={handleApprove}>
    ...
    return (
        <Alert color="success" icon={false} sx={{ display: "block" }}>
            ...
            <Grid container spacing={4}>
                <Grid item>
                    <FormControlLabel
                        control={<Checkbox checked={SLO} onClick={(e) => setSLO(e.target.checked)} color="success" />}
                        label="Request SLO approval"
                    />
                </Grid>
                <Grid item>
                    <FormControlLabel
                        control={<Checkbox checked={SLC} onClick={(e) => setSLC(e.target.checked)} color="success" />}
                        label="Request SLC approval"
                    />
                </Grid>
                <Grid item>
                    <FormControlLabel
                        control={<Checkbox checked={GAD} onClick={(e) => setGAD(e.target.checked)} color="success" />}
...
function DeletionView({ setView }) {
    ...
    return <Alert color="error" icon={false} sx={{ display: "block" }}>
