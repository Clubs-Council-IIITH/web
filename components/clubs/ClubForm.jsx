...
export default function ClubForm({
  ...
  const [descriptionmd, setDescriptionmd] = useState(defaultValues?.description?.md || "");
  const [descriptionhtml, setDescriptionhtml] = useState(defaultValues?.description?.html || "");
                ...
                <>
                  ...
                  <Box>
                    ...
                    <Controller
                      ...
                      control={control}
                      render={({ field }) => (
                        <Select fullWidth disabled={disableRequiredFields} {...field}>
