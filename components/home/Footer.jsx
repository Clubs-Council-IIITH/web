  ...
  return (
    <Box>
      ...
      <Grid container py={5} spacing={2} justifyContent="space-between">
        ...
        >
          <IconButton component="a" href={DISCORD_URL} sx={{ mx: 1, color: "text.primary" }}>
            <Iconify icon="akar-icons:discord-fill" />
          </IconButton>
          <IconButton component="a" href={TWITTER_URL} sx={{ mx: 1, color: "text.primary" }}>
            <Iconify icon="akar-icons:twitter-fill" />
          </IconButton>
          <IconButton component="a" href={FACEBOOK_URL} sx={{ mx: 1, color: "text.primary" }}>
            <Iconify icon="akar-icons:facebook-fill" />
          </IconButton>
          <IconButton component="a" href={INSTAGRAM_URL} sx={{ mx: 1, color: "text.primary" }}>
