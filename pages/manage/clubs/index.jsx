...
export default function Clubs() {
  ...
  useEffect(() => {
    const filteredRows = clubs?.filter(
      (club) =>
...
function ClubsTableRow(club) {
  ...
  return (
    <TableRow hover onClick={() => router.push(`/manage/clubs/${cid}`)} sx={{ cursor: "pointer" }}>
      ...
      <TableCell align="center" sx={{ border: "none" }}>
        <Label color={state === "active" ? "success" : "error"}>{state?.toUpperCase()}</Label>
      </TableCell>
    </TableRow>
  );
}
