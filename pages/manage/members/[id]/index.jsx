              ...
              <Grid container spacing={2}>
                ...
                <Grid item width="100%">
                  ...
                  <Box mt={4}>
                    ...
                    <Typography variant="caption" fontWeight={400} textTransform="lowercase">
                      <code>{userProfile?.email}</code>
                    </Typography>

                    <Typography mt={3} variant="subtitle2" color="text.secondary">
                      MEMBER SINCE
                    </Typography>
                    <Typography variant="body1">
                      {Math.min(...member?.roles?.map((role) => role.startYear))}
                    </Typography>
                  </Box>
                </Grid>
              </Grid>
