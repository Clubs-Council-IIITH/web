  ...
  return (
    <Page title="About">
      <Container>
        ...
        <Typography variant="body1">
          Student Life Comittee is dedicated to enhancing the overall student experience and
          fostering a vibrant and inclusive campus community. We believe that student life is an
          integral part of a well-rounded education, and we strive to create opportunities for
          personal growth, leadership development, and meaningful connections among students.
          <br /> <br />
          Our committee consists of passionate student representatives who work closely with
          faculty, staff, and the wider student body to organize and coordinate a wide range of
          events, programs, and initiatives. From social gatherings and cultural celebrations to
          educational workshops and community service projects, we aim to provide diverse
          opportunities for students to explore their interests, build lasting friendships, and make
        ...
        <Typography variant="body1">
          ...
          extra-curricular activities for all students across campus and empowering students
          ...
          and provide the support you need. We understand that your time in college is about more
          than just attending classes and studying; it&apos;s about discovering your passions and
          creating lasting memories. That&apos;s why we offer a variety of programs and initiatives
          designed to enrich your student life experience.
        </Typography>
